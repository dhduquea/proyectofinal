...
with col2:
    ...
    """)
    st.image("media/heatmap_rad_sol.jpeg", caption='Municipos con mayor radiación solar en un periodo de 10 años',use_container_width=True)
    st.markdown("<h7 style='text-align: center;'>Municipios con Mayor Radiación Solar:</h2>", unsafe_allow_html=True)
    st.write("""
